...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent('''
            Examples:
            generate_averaged4d -i images -o images
            For BIDS:
            generate_averaged4d -i . -o . --image-suffix "" --output-image-suffix "" -d "sub-" -u "anat"
        '''),
    ...
    partial_generate_averaged4d = partial(
        generate_averaged4d,
        images_path=images_path,
        output_path=output_path,
        image_suffix=image_suffix,
    ...
    with mp.Pool() as pool:
        process_map(partial_generate_averaged4d, images_path_list, max_workers=max_workers)


def generate_averaged4d(
        image_path,
        images_path,
        output_path,
        image_suffix,
