...
def inference(
    ...
    if loc_path is not None:
        ...
        if not keep_only[0] or 'preview' in keep_only:
            ...
            preview_jpg_mp(
                ...
                label_texts_left={
                    50: 'Sacrum', 63: 'C2C3', 64: 'C3C4', 65: 'C4C5', 66: 'C5C6', 67: 'C6C7', 68: 'C7C8', 69: 'C8C9',
    ...
    if not keep_only[0] or 'preview' in keep_only:
        ...
        preview_jpg_mp(
            ...
            quiet=quiet,
            label_texts_left={
                63: 'C2C3', 64: 'C3C4', 65: 'C4C5', 66: 'C5C6', 67: 'C6C7', 68: 'C7C8', 69: 'C8C9',
                71: 'C7T1', 72: 'T1T2', 73: 'T2T3', 74: 'T3T4', 75: 'T4T5', 76: 'T5T6', 77: 'T6T7',
                78: 'T7T8', 79: 'T8T9', 80: 'T9T10', 81: 'T10T11', 82: 'T11T12', 83: 'T12T13', 84: 'T13T14', 85: 'T14T15', 86: 'T15T16', 87: 'T16T17', 88: 'T17T18', 89: 'T18T19',
                91: 'T12L1', 92: 'L1L2', 93: 'L2L3', 94: 'L3L4', 95: 'L4L5', 96: 'L5L6', 97: 'L6L7', 98: 'L7L8', 99: 'L8S', 100: 'L5S'
            },
    ...
    if not keep_only[0] or 'preview' in keep_only:
        ...
        preview_jpg_mp(
            ...
            max_workers=max_workers,
            quiet=quiet,
            label_texts_right={i: f'{i}' for i in range(61, 101)},
        )
